namespace panini {
    ...
    inline void copyFromNodeSinglePoint(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,int i1,int i2,int i3)
    {
        lbModel.fTemp0[0][lbModel.CENTER_DV_ZERO_ZERO_ZERO] = myGrid(i1,i2,i3,lbModel.G0,myGrid.node[lbModel.G0],lbModel.CENTER_DV_ZERO_ZERO_ZERO);
        
        int index = myGrid.getIndex(i1,i2,i3,lbModel.G1,myGrid.node[lbModel.G1],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp1[0][dv]   =     myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G2,myGrid.node[lbModel.G2],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp2[0][dv]  =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G3,myGrid.node[lbModel.G3],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp3[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G4,myGrid.node[lbModel.G4],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp4[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G5,myGrid.node[lbModel.G5],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp5[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G6,myGrid.node[lbModel.G6],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp6[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G7,myGrid.node[lbModel.G7],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp7[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G8,myGrid.node[lbModel.G8],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp8[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G9,myGrid.node[lbModel.G9],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp9[0][dv]   =    myGrid.value(index+dv) ;
        
        index = myGrid.getIndex(i1,i2,i3,lbModel.G10,myGrid.node[lbModel.G10],  0);   
        for(int dv=0;dv<4;dv++)
            lbModel.fTemp10[0][dv]   =    myGrid.value(index+dv) ;
        
    }
    
    template <int N,int numblock, typename dataType1>
    inline void getRhoNodeSinglePoint(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,dataType1 &rho, int i1,int i2,int i3)
    {
        rho = 0.0;
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoCellSinglePoint(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,dataType1 &rho, int i1,int i2,int i3)
    {
        rho = 0.0;
...
//         twoMinusU2 = 2.0-u2;
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackNodeG12(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
        dataType1 rho(0.0);
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackNodeG34(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
        dataType1 rho(0.0);
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackNodeG56(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
         dataType1 rho(0.0);
       for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackNodeG910(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
         dataType1 rho(0.0);
       for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackNodeCellG78(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
         dataType1 rho(0.0);
       ///////////////////
        // Node --> Cell //
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackCellG12(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
        dataType1 rho(0.0);
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackCellG34(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
         dataType1 rho(0.0);
       for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackCellG56(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {
         dataType1 rho(0.0);
       for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void getRhoForDiffuseBounceBackCellG910(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID)            
    {  
         dataType1 rho(0.0);
       for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackNodeG12(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
    {
...
//                         ZZM2 - Correction
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackNodeG34(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackNodeG56(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)             
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackNodeG910(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackCellG12(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackCellG34(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackCellG56(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)             
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackCellG910(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        for (int i3 = myGrid.nE3; i3 >= myGrid.nB3; i3--)                   
        {                                                                
    ...
    template <int N,int numblock, typename dataType1>
    inline void diffusebounceBackNodeCellG78(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)             
    {
        dataType1 rho(0.0),uX(0.0),uY(0.0),uZ(0.0),theta(0.0); 
        ///////////////////
        // Node --> Cell //
       ...
       template <int N,int numblock, typename dataType1> 
       inline void diffusebounceBack(lbmRD3Q41<dataType1> &lbModel, gridBCC3D<N, numblock, dataType1> &myGrid,gridBCC3D<1, 1, int> &marker,gridBCC3D<1, 1, dataType1> &rhoGrid ,int FLUID, int SOLID, dataType1 uXBody, dataType1 uYBody, dataType1 uZBody)            
       {
         ...
         diffusebounceBackNodeG12(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackNodeG34(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackNodeG56(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackNodeG910(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);       
         diffusebounceBackCellG12(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackCellG34(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackCellG56(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackCellG910(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);
         diffusebounceBackNodeCellG78(lbModel,myGrid,marker,rhoGrid,FLUID,SOLID,uXBody,uYBody,uZBody);    
