...
template void probeComputationalGridPlane12Node<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void probeComputationalGridPlane12Cell<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void probeComputationalGridPlane23Node<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void probeComputationalGridPlane23Cell<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void probeComputationalGridPlane31Node<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void probeComputationalGridPlane31Cell<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );

template void modifyComputationalGridPlane12Node<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void modifyComputationalGridPlane12Cell<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void modifyComputationalGridPlane23Node<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void modifyComputationalGridPlane23Cell<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void modifyComputationalGridPlane31Node<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
template void modifyComputationalGridPlane31Cell<4,11,double>(gridBCC3D<4,11,double> &, int , double *, int ,   int , int  , int );
